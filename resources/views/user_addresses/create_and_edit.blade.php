			...
			<div class="panel-body">
				...
				<user-addresses-create-and-edit inline-template>
					<form role="form" class="form-horizontal" action="{{ route('user_addresses.store') }}" method="post">
						...
						{{ csrf_field() }}
						<!-- 注意这里多了@change -->
						<!-- <select-district @change="onDistrictChanged" inline-template> 可以看到比之前多了一个 @change="onDistrictChanged"，代表 select-district 的 change 事件将由 onDistrictChanged 这个方法来处理。 -->
