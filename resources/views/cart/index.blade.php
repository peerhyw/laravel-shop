			...
			<div class="panel-body">
				...
				<div>
					<form class="form-horizontal" role="form" id="order-form">
						...
						<!-- 优惠码开始 -->
						<div class="form-group">
							<label for="" class="control-label col-sm-3">优惠码</label>
							<div class="col-sm-4">
							...
							<div class="col-sm-3">
								...
								<button class="btn btn-danger" id="btn-cancel-coupon" style="display: none;">取消</button>
							</div>
						</div>
						<!-- 优惠码取消 -->
						<div class="form-group">
...
<script>
	$(document).ready(function(){
		...
		$('.btn-remove').click(function(){
			//$(this)可以获取到当前点击的 移除 按钮的jQuery对象
			...
			.then(function(willDelete){
				//用户点击 确定 按钮，willDelete的值就会说true 否则为false
				if(!willDelete){
					return;
				}
		...
		$('#select-all').change(function(){
			...
			//对于已经下架的商品我们不希望对应的勾选框会被选中，因此我们需要加上:not([diabled])这个条件
